...
| 模块依赖变更 | `package.json/pyproject.toml` 修改 | 更新模块卡片 dependencies |
| 模块增删 | `package.json/pyproject.toml` Modules 变更或新目录 | 更新 MODULE_INDEX.yaml |
...
sync_report:
  status: blocked
  reason: "<原因 — git 不可用/非 git 仓库/无新变更>"
```
