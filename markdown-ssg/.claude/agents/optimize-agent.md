...
description: >
  ...
  结合项目已有代码、Node.js/TypeScript 生态与最佳实践，生成2-4个高质量备选方案，
...
2. 项目相关源码（Read 后注入）
3. 模块卡片
4. explore-agent 搜索结果（如有 — 代码调研结果）
...
1. 现有架构是否能容纳用户的方案？
2. 是否有已有代码可直接复用？
3. package.json 依赖是否能支撑？

### 阶段 3：发散生成备选方案（≥2 个）

基于项目约束 + TypeScript/Node.js 最佳实践，生成 2-4 个备选方案：
...
按加权得分排序，给出推荐理由。标准任务权重偏向"简单+TypeScript惯例+一致性"，性能敏感任务权重偏向"性能+可维护性"。
